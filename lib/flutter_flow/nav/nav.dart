...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      errorBuilder: (context, state) =>
          appStateNotifier.loggedIn ? ExerciseLibraryWidget() : SigninWidget(),
      routes: [
        FFRoute(
          name: '_initialize',
          path: '/',
        ...
        FFRoute(
          ...
          builder: (context, params) => ExerciseWidget(
            exerciseId: params.getParam('exerciseId', ParamType.String),
            exercise: params.getParam('exercise', ParamType.String),
          ),
        ),
        FFRoute(
          name: 'timer',
          ...
          builder: (context, params) => TimerWidget(
            isFromProgram: params.getParam('isFromProgram', ParamType.bool),
          ),
        ),
        FFRoute(
          name: 'program',
          ...
          builder: (context, params) => ProgramWidget(
            isFromTimer: params.getParam('isFromTimer', ParamType.bool),
          ),
        ),
        FFRoute(
          name: 'signin',
        ...
        FFRoute(
          name: 'nutritionhub',
          path: '/nutritionhub',
          builder: (context, params) => NutritionhubWidget(),
        ),
        FFRoute(
          name: 'info',
          path: '/info',
