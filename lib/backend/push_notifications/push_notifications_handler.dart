...
final parametersBuilderMap =
  ...
  'exerciseLibrary': ParameterData.none(),
  'exercise': (data) async => ParameterData(
        allParams: {
          'exerciseId': getParameter<String>(data, 'exerciseId'),
          'exercise': getParameter<String>(data, 'exercise'),
        },
      ),
  'timer': (data) async => ParameterData(
        allParams: {
          'isFromProgram': getParameter<bool>(data, 'isFromProgram'),
        },
      ),
  'program': (data) async => ParameterData(
        allParams: {
          'isFromTimer': getParameter<bool>(data, 'isFromTimer'),
        },
      ),
