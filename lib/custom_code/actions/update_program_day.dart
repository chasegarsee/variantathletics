...
Future updateProgramDay(
    String programId, int weekIndex, int dayIndex, DaysStruct day) async {
    ...
    if (programSnapshot.exists) {
      ...
      if (weeks != null && weekIndex >= 0 && weekIndex < weeks.length) {
        ...
        if (days != null && dayIndex >= 0 && dayIndex < days.length) {
          // Update the 'days' array at the specified dayIndex with the new day data
          days[dayIndex] = day.toMap();
