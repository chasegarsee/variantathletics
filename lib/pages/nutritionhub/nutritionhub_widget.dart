              ...
              Builder(
                builder: (context) {
                  ...
                  return Column(
                    mainAxisSize: MainAxisSize.max,
                    children:
                        List.generate(percentages.length, (percentagesIndex) {
                      final percentagesItem = percentages[percentagesIndex];
                      return Text(
                        percentagesItem.toString(),
