            ...
            SingleChildScrollView(
              child: Column(
                ...
                children: [
                  ...
                  if (valueOrDefault<bool>(currentUserDocument?.isCoach, false))
                    Padding(
                      padding:
                          EdgeInsetsDirectional.fromSTEB(0.0, 0.0, 0.0, 10.0),
                      child: AuthUserStreamWidget(
                                  ...
                                  child: Padding(
                                    ...
                                    child: Row(
                                      ...
                                      children: [
                                        Text(
                                          FFLocalizations.of(context).getText(
                                            'tp6kfy1h' /* Account Status: VARIANT LIFETI... */,
                                          ),
                                          style: FlutterFlowTheme.of(context)
                                              .bodyMedium,
                                        ),
